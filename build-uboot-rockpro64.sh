...
patch -p1 ../patches/0001-Add-missing-header-which-fails-on-recent-GCC.patch
patch -p1 ../patches/0002-Generic-boot-code-for-Mender.patch
patch -p1 ../patches/0003-Integration-of-Mender-boot-code-into-U-Boot.patch
patch -p1 ../patches/0004-add-config_mender_defines.h.patch
patch -p1 ../patches/0005-configs-rockpro64-add-Mender-support.patch
...
if [ "$rockpro64_config" == "emmc" ]; then
    patch -p1 ../patches/0006-RockPro64-eMMC-integration-for-Mender.patch
fi
...
cd -
pwd
tar czvf rockpro64_${rockpro64_config}-${uboot_version}.tar.gz ./*
